    ...
    <>
      ...
      >
        ...
        <div className="flex items-center gap-8">
          ...
          <Link href="/skills" className="text-[13px] text-ink font-medium">
            Skills
          </Link>
      ...
      >
        <div className="max-w-[1080px] mx-auto py-[10px] flex items-center gap-2 text-[12px] text-muted">
          ...
          <span>/</span>
          <Link href="/skills" className="text-muted transition-colors hover:text-ink">
            Skills Library
          </Link>
          <span>/</span>
          <span>{cat}</span>
        ...
        <div className="max-w-[1080px] mx-auto">
          ...
          >
            ...
            <span className="text-[10px] font-mono text-[#555]">
              #{String(globalIdx + 1).padStart(2, '0')} · {pos} of {total} in category
            </span>
          </div>
          <h1
          ...
          <p
            ...
            style={{ animation: 'blurIn .7s cubic-bezier(.16,1,.3,1) .28s forwards' }}
          >
            {desc}
          </p>
          <div
      ...
      >
        <div className="max-w-[1080px] mx-auto grid gap-12 items-start" style={{ gridTemplateColumns: '1fr 320px' }}>
          {/* Main Content */}
          <div className="min-w-0">
            ...
            <div className="rounded-[14px] overflow-hidden mb-14" style={{ background: '#0B0B0A' }}>
              <div className="px-4 py-[10px] flex items-center gap-2" style={{ borderBottom: '.5px solid rgba(255,255,255,.08)' }}>
            ...
            <div className="grid gap-[14px]" style={{ gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))' }}>
              <div className="bg-white border border-border rounded-[14px] p-6">
                ...
                >
                  {uni ? 'universal — always included' : `${tags[0]} detected in repo`}
                </span>
              </div>
              <div className="bg-white border border-border rounded-[14px] p-6">
                <div
            ...
            {next && (
              ...
              >
                ...
                <div className="text-[16px] font-semibold text-ink">{next[2]}</div>
              </Link>
            )}
          </div>
            ...
            <div className="bg-surface border border-border rounded-[14px] overflow-hidden">
              ...
              <div className="px-5 py-[6px_5px_12px]">
                ...
                >
                  ...
                  <span className="font-medium">{uni ? tags.length - 1 : tags.length}</span>
                </div>
                <div
                  className="flex justify-between py-[9px] text-[13px]"
                  style={{ borderBottom: '.5px solid #E5E3DC' }}
                >
                  ...
                  <span className="font-medium" style={{ color: uni ? '#1B6B28' : '#888785' }}>
                    {uni ? 'Yes' : 'No'}
                  </span>
                </div>
            ...
            <div className="bg-white border border-border rounded-[14px] overflow-hidden">
              ...
              <div className="p-3 flex flex-col gap-2">
                {related.map((r) => {
                  ...
                  const shortDesc = rDesc.length > 70 ? rDesc.slice(0, 70) + '…' : rDesc
                  return (
                    <Link
                      key={rName}
                      href={`/skills/${rSlug}`}
      ...
      >
        <div className="max-w-[720px] mx-auto">
          ...
          <p className="text-[14px] text-[#777] leading-[1.65] m-0 mb-8">
            MARK auto-selects this skill along with 5–7 others tailored to your repo.
          </p>
