...
Produk ini juga memiliki **landing page** di `markintel.xyz` yang berfungsi sebagai marketing page sekaligus demo interaktif untuk pump.fun launch.
...
3. SCAN BERJALAN (SSE streaming)
   └─ Popup kirim request ke markintel.xyz/api/forge
...
```
markintel.xyz/               ← Single Vercel Project
├── app/
...
```typescript
export const API_BASE = 'https://markintel.xyz'
