(function() {let __HMR_ID = "0.l23lph0me1";
...
function Popup() {
    ...
    const listener = (msg) => {
      ...
      if (["STATE_UPDATE", "SCAN_STARTED", "IDEAS_READY", "RATE_LIMITED", "SCAN_ERROR"].includes(msg.type)) {
        chrome.storage.local.get("scanState", (result) => {
          var _a;
          console.log("[MARK Popup] scanState from storage:", (_a = result.scanState) == null ? void 0 : _a.status);
          if (result.scanState) setState(result.scanState);
        });
      }
    };
  ...
  const handleScan = () => {
    ...
    setState((prev) => ({
      ...prev,
      status: "scanning",
      lines: [{ type: "status", text: "→ Starting scan...", cls: "blue" }]
    }));
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "popup-root", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "popup-header", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "popup-logo", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "logo-dot" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "MARK" })
      ] }),
      repo && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "popup-repo", children: [
        repo.owner,
        "/",
        repo.repo
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(GlassZone, { state }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "popup-body", children: [
      !repo && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "no-repo", children: "Open any GitHub repository to use MARK" }),
      repo && state.status === "idle" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "idle-state", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "scan-btn", onClick: handleScan, children: "Scan this repo" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "remaining-info", children: [
          state.remaining,
          " scans remaining today"
        ] })
      ] }),
      state.status === "rate_limited" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rate-limit-msg", children: [
        "You've used 5/5 scans today.",
        /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
        "Come back tomorrow."
      ] }),
      state.status === "error" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "error-msg", children: state.error || "Scan failed. Please try again." }),
      (state.status === "scanning" || state.status === "done") && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "tabs", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: `tab ${activeTab === "mark" ? "active" : ""}`, onClick: () => setActiveTab("mark"), children: "Mark File" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: `tab ${activeTab === "ideas" ? "active" : ""}`, onClick: () => setActiveTab("ideas"), children: "Build Opportunities" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "tab-content", children: [
          activeTab === "mark" && /* @__PURE__ */ jsxRuntimeExports.jsx(MarkFileTab, { state, onDownload: handleDownload }),
          activeTab === "ideas" && /* @__PURE__ */ jsxRuntimeExports.jsx(IdeasTab, { ideas: state.ideas })
        ] })
      ] })
    ] }),
    repo && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "popup-footer", children: [
      state.status === "done" && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "status-indicator", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Scan complete" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "footer-actions", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "btn-dl", onClick: handleDownload, children: "↓ ZIP" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "btn-rescan", onClick: handleRescan, children: "↺ Rescan" })
        ] })
      ] }),
      state.status === "scanning" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "scanning-indicator", children: "Scanning..." }),
      state.status === "idle" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "remaining-footer", children: [
        state.remaining,
...
function GlassZone({ state }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-zone", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("canvas", { ref: canvasRef, className: "glass-canvas" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-overlay", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "scan-status", children: getScanStatusText(state.status) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "chip-row", children: [
        state.tags.slice(0, 4).map((tag, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "chip", style: { animationDelay: `${i * 50}ms` }, children: tag }, i)),
        state.skills.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "chip chip-accent", children: [
          state.skills.length,
          " skills"
        ] })
      ] })
...
function MarkFileTab({ state, onDownload }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    state.lines.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "terminal", children: [
      state.lines.map((line, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `term-line ${line.cls || ""}`, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "term-prefix", children: "·" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: line.text })
      ] }, i)),
      state.status === "scanning" && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "cursor" })
    ] }),
    state.status === "done" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "file-list", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "file-row", onClick: onDownload, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "file-icon", children: "📄" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "file-name", children: "CLAUDE.md" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "file-tags", children: state.tags.slice(0, 3).join(" · ") })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "dl-icon", children: "↓" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "file-row", onClick: onDownload, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "file-icon", children: "📁" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "file-name", children: "mark-output.zip" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "file-tags", children: [
            "CLAUDE.md + ",
            state.skills.length,
            " skills + setup guide"
          ] })
...
function IdeasTab({ ideas }) {
  if (ideas.length === 0) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "ideas-loading", children: "Generating ideas..." });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "ideas-list", children: ideas.map((idea, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(IdeaCard, { idea, delay: i * 200 }, i)) });
}
function IdeaCard({ idea, delay }) {
  const [visible, setVisible] = reactExports.useState(false);
  reactExports.useEffect(() => {
    const t = setTimeout(() => setVisible(true), delay);
    return () => clearTimeout(t);
  }, [delay]);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `idea-card ${visible ? "visible" : ""}`, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "idea-header", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "idea-name", children: idea.websiteName }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "idea-ticker", children: idea.ticker })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "idea-desc", children: idea.valueProp }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "idea-footer", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "idea-pf", children: "pump.fun viable ✓" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "idea-effort", children: idea.buildEffort })
    ] })
  ] });
}
...
init();
//# sourceMappingURL=index-DozXg9GO.js.map
